 ...
 */
angular.module('boltApp.controllers.Event', ['google-maps'])
    .controller('EventCtrl', ['$scope', '$rootScope', 'getEvent', '$window', '$location', 'ezfb', function ($scope, $rootScope, getEvent, $window, $location, ezfb) {
        ...
        $scope.marker = {
            ...
            options: {
                icon: {
                    ...
                    fillColor: '#ff5c40',
                    anchor: $rootScope.windowWidth > 1080 ? new google.maps.Point(10, 30) : new google.maps.Point(15, 44),
                    fillOpacity: 1,
                    scale: 1,
                    strokeWeight: 0
                }
        ...
        getEvent.$promise.then(function () {
            ...
            $rootScope.eventTitle = getEvent.event.title;
