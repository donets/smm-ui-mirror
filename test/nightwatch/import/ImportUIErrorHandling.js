module.exports = {
  ...
  'Go to my account and upload photo': function (browser) {
    ...
    browser
	  ...
	  .pause(1000)//задержка чтоб ответ пришел от јѕ» на предмет серверсайдовых валидаций, не удивлюсь если на CI будет падать....
  },
  
    'Validate all rows contain an error': function (browser) { 
	//элементы дл€ падающих в данный момент тестов ['9','17'],['10','17'],['11','17'],['12','7'],['13','7'],['20','3'],['21','3'],['22','3'],['22','3']
	...
	var tests=[['1','2'],['2','9'],['3','10'],['4','11'],['5','16'],['6','16'],['7','17'],['8','17'],['14','15'],['15','15'],['16','13'],
		...
		['31','15'],['32','13'],['33','14']] //массив с провер€емыми €чейками, новые добавить сюда-же в любое место
		s = 'function TestAll(){'
		s = s+'browser\n'
